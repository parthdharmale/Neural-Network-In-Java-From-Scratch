...
public class App {
  ...
  public void trainAndPredict() {
    ...
    Network network500 = new Network(1000);
    ...
    System.out.println(String.format("  male, 167, 73: network500: %.10f ", network500.predict(167, 73)));
    System.out.println(String.format("female, 105, 67: network500: %.10f ", network500.predict(105, 67)));
    System.out.println(String.format("female, 120, 72: network500: %.10f ", network500.predict(120, 72)));
    System.out.println(String.format("  male, 143, 67: network500: %.10f ", network500.predict(143, 67)));
    System.out.println(String.format(" male, 150, 66: network500: %.10f ", network500.predict(150, 66)));
